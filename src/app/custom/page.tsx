...
export default function CustomJewelryPage() {
    return (
        <div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-b from-[hsl(var(--background))] to-[hsl(var(--background))] px-4 py-12">
            <div className="max-w-2xl w-full text-center">
                {/* Decorative Elements */}
                <div className="relative mb-10">
                    <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-[hsl(var(--secondary))] to-[hsl(var(--secondary))] flex items-center justify-center mb-6 shadow-elegant">
                        <svg
                ...
                <div className="mb-12">
                    ...
                    <div className="w-full h-2 bg-[hsl(var(--card))] rounded-full overflow-hidden">
                        <div
                            className="h-full bg-gradient-to-r from-[hsl(var(--secondary))] to-[hsl(var(--secondary))] rounded-full"
                            style={{ width: '40%' }}
                        ></div>
                    </div>
                </div>
